//
// Generated file, do not edit! Created by nedtool 5.6 from FL/TraCIDemo11pMessage.msg.
//
...
void TraCIDemo11pMessage::copy(const TraCIDemo11pMessage& other)
{
    ...
    this->senderIdx = other.senderIdx;
    this->destIdx = other.destIdx;
    this->destIdcs = other.destIdcs;
    this->messageSendingTime = other.messageSendingTime;
}
...
void TraCIDemo11pMessage::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->senderIdx);
    doParsimPacking(b,this->destIdx);
    doParsimPacking(b,this->destIdcs);
    doParsimPacking(b,this->messageSendingTime);
}
...
void TraCIDemo11pMessage::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->senderIdx);
    doParsimUnpacking(b,this->destIdx);
    doParsimUnpacking(b,this->destIdcs);
    doParsimUnpacking(b,this->messageSendingTime);
}
...
int TraCIDemo11pMessage::getSenderIdx() const
{
    return this->senderIdx;
}

void TraCIDemo11pMessage::setSenderIdx(int senderIdx)
{
    this->senderIdx = senderIdx;
}

int TraCIDemo11pMessage::getDestIdx() const
{
    return this->destIdx;
}

void TraCIDemo11pMessage::setDestIdx(int destIdx)
{
    this->destIdx = destIdx;
}

const char * TraCIDemo11pMessage::getDestIdcs() const
{
    return this->destIdcs.c_str();
}

void TraCIDemo11pMessage::setDestIdcs(const char * destIdcs)
{
    this->destIdcs = destIdcs;
}

double TraCIDemo11pMessage::getMessageSendingTime() const
{
    return this->messageSendingTime;
}

void TraCIDemo11pMessage::setMessageSendingTime(double messageSendingTime)
{
...
int TraCIDemo11pMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='s' && strcmp(fieldName, "senderIdx")==0) return base+3;
    if (fieldName[0]=='d' && strcmp(fieldName, "destIdx")==0) return base+4;
    if (fieldName[0]=='d' && strcmp(fieldName, "destIdcs")==0) return base+5;
    if (fieldName[0]=='m' && strcmp(fieldName, "messageSendingTime")==0) return base+6;
...
const char **TraCIDemo11pMessageDescriptor::getFieldPropertyNames(int field) const
{
    ...
    switch (field) {
        case 6: {
            static const char *names[] = { "units",  nullptr };
            return names;
        }
...
const char *TraCIDemo11pMessageDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    ...
    switch (field) {
        case 6:
            if (!strcmp(propertyname,"units")) return "s";
            return nullptr;
        default: return nullptr;
    }
}
...
std::string TraCIDemo11pMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 3: return long2string(pp->getSenderIdx());
        case 4: return long2string(pp->getDestIdx());
        case 5: return oppstring2string(pp->getDestIdcs());
        case 6: return double2string(pp->getMessageSendingTime());
        default: return "";
    }
}
...
bool TraCIDemo11pMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 3: pp->setSenderIdx(string2long(value)); return true;
        case 4: pp->setDestIdx(string2long(value)); return true;
        case 5: pp->setDestIdcs((value)); return true;
        case 6: pp->setMessageSendingTime(string2double(value)); return true;
