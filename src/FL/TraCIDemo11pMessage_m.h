...
/**
 * Class generated from <tt>FL/TraCIDemo11pMessage.msg:35</tt> by nedtool.
 * <pre>
 ...
 *     int destIdx;
 *     string destIdcs;
 *     double messageSendingTime \@units(s);
 * }
 * </pre>
 */
class TraCIDemo11pMessage : public ::veins::BaseFrame1609_4
{
  protected:
    ...
    int senderIdx;
    int destIdx;
    ::omnetpp::opp_string destIdcs;
    double messageSendingTime;
  ...
  public:
    ...
    virtual int getSenderIdx() const;
    virtual void setSenderIdx(int senderIdx);
    virtual int getDestIdx() const;
    virtual void setDestIdx(int destIdx);
    virtual const char * getDestIdcs() const;
    virtual void setDestIdcs(const char * destIdcs);
    virtual double getMessageSendingTime() const;
    virtual void setMessageSendingTime(double messageSendingTime);
};
